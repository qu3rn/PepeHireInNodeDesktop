...
export interface JobAssistantApi {
  jobIndex: {
    search(
      filters: import("../job-index/job-index.types").JobIndexFilters
    ): Promise<import("../job-index/job-index.types").JobIndexSearchResult>;
    collect(
      criteria: import("../job-index/job-index.types").JobIndexCriteria
    ): Promise<{ runIds: string[] }>;
    reindex(
      options?: import("../job-index/job-index.types").ReindexOptions
    ): Promise<import("../job-index/job-index.types").ReindexSummary>;
    cleanupPreview(
      options: import("../job-index/job-index.types").CleanupOptions
    ): Promise<import("../job-index/job-index.types").CleanupPreview>;
    cleanupExecute(
      options: import("../job-index/job-index.types").CleanupExecuteOptions
    ): Promise<import("../job-index/job-index.types").CleanupSummary>;
    recheck(
      options?: import("../job-index/job-index.types").AvailabilityOptions
    ): Promise<import("../job-index/job-index.types").AvailabilitySummary>;
    updateStatus(
      offerId: string,
      status: import("./types").OfferStatus
    ): Promise<Offer>;
    listProfiles(): Promise<
      import("../job-index/search-profile").SearchProfile[]
    >;
    updateRelevance(offerId: string, relevant: boolean): Promise<Offer>;
  };
  offers: {
  ...
  collection: {
    ...
    saveCollectedUrl(
      input: Omit<CollectedUrl, "id" | "createdAt" | "updatedAt">
  ...
  rapidApply: {
    ...
    prepare(
      input: import("./types").RapidApplyInput
    ): Promise<import("./types").RapidApplyPreview>;
    submit(
      input: import("./types").RapidApplyInput
    ): Promise<import("./types").RapidApplyResult>;
